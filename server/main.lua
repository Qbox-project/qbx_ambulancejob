...
-- Commands
QBCore.Commands.Add('911e', Lang:t('info.ems_report'), {
    {name = 'message', help = Lang:t('info.message_sent')}
...
QBCore.Commands.Add("revive", Lang:t('info.revive_player_a'), {
...
QBCore.Commands.Add("setpain", Lang:t('info.pain_level'), {
    {name = "id", help = Lang:t('info.player_id')}
}, false, function(source, args)
    local src = source
...
QBCore.Commands.Add("kill", Lang:t('info.kill'), {
    {name = "id", help = Lang:t('info.player_id')}
}, false, function(source, args)
    if args[1] then
        local Player = QBCore.Functions.GetPlayer(tonumber(args[1]))
...
QBCore.Commands.Add('aheal', Lang:t('info.heal_player_a'), {
    {name = 'id', help = Lang:t('info.player_id')}
}, false, function(source, args)
    if args[1] then
        local Player = QBCore.Functions.GetPlayer(tonumber(args[1]))
        ...
        TriggerClientEvent('hospital:client:adminHeal', source)
    end
end, 'admin')
